...
let testStandard: [TestAge: [FitnessTest]] = [
    .one: [FitnessTest(type: .running, standard: ["특급" : (1, 12 * 60 + 30), "1급" : (12 * 60 + 31, 13 * 60 + 32), "2급" : (13 * 60 + 33, 14 * 60 + 34), "3급" : (14 * 60 + 35, 15 * 60 + 36), "불합격" : (15 * 60 + 37, 180 * 60)]), FitnessTest(type: .pushup, standard: ["특급" : (72,999), "1급" : (64, 71), "2급" : (56,63), "3급" : (48,55), "불합격" : (0, 47)]), FitnessTest(type: .situp, standard: ["특급": (86,999), "1급" : (78, 85), "2급" : (70,77), "3급" : (62, 69), "불합격" : (0,61)])],
