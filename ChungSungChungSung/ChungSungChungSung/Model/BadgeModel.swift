...
struct BadgeData {
    var list = [
        BadgeModel(title: "우리의 시작", image: "firstStep", description: "군피트를 시작한 것을 환영합니다!"),
        BadgeModel(title: "첫 기록의 기쁨", image: "firstRecord", description: "첫 운동 기록을 추가했어요."),
        BadgeModel(title: "일주일 연속 운동", image: "sevenDays", description: "일주일 동안 매일 운동을 기록했어요."),
        BadgeModel(title: "한 달 연속 운동", image: "medal30Days", description: "한 달 동안 매일 운동을 기록했어요."),
        BadgeModel(title: "체력검정 1급", image: "medal1Achiever", description: "체력검정 세 종목 모두 1급을 달성했어요."),
        ...
        BadgeModel(title: "팔굽혀펴기 특급", image: "pushUp", description: "체력검정 팔굽혀펴기 특급을 달성했어요."),
        ...
        BadgeModel(title: "목표 첫 달성", image: "firstGoal", description: "설정한 목표를 처음 달성했어요."),
